    ...
    <section className="rounded-[32px] bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.06)] ring-1 ring-slate-200 sm:p-7">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#9a7b1d]">Produtos em destaque</p>
            <p className="text-sm text-[#6f716f]">Produtos selecionados para você.</p>
          </div>
        </div>
