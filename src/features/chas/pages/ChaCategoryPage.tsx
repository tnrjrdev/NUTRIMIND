      ...
      <div className="space-y-6">
        <section className="rounded-[28px] border border-[#eadfbe] bg-white p-5 shadow-[0_14px_36px_rgba(92,68,11,0.05)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <h2 className="text-xl font-semibold text-[#2d2d2d]">Chas da categoria</h2>
                  ...
                  <div className="mt-3 flex flex-wrap gap-6">
                    <label className="inline-flex items-center gap-3 text-sm font-medium text-[#4f493e]">
                      <button
                        ...
                        className={`relative h-7 w-14 rounded-full transition ${formData.usoAdulto ? 'bg-[#b89614]' : 'bg-slate-300'}`}
                    ...
                    <label className="inline-flex items-center gap-3 text-sm font-medium text-[#4f493e]">
                      <button
                        ...
                        className={`relative h-7 w-14 rounded-full transition ${formData.usoInfantil ? 'bg-[#b89614]' : 'bg-slate-300'}`}
