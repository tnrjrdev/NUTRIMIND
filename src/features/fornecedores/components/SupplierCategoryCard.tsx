import type { SupplierCategory } from "../types/fornecedores.types";

type SupplierCategoryCardProps = {
  category: SupplierCategory;
};

export function SupplierCategoryCard({ category }: SupplierCategoryCardProps) {
  return (
    <button
      type="button"
