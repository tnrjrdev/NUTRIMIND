...
import com.nutrimind.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    @Value("${nutrimind.cors.allowed-origins}")
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Pagina de erro: precisa ser liberada para que o status real
                        // (404/500) nao seja mascarado como 401 no dispatch de erro.
    ...
    PasswordEncoder passwordEncoder() {
        // Compativel com os hashes legados $2a$/$2b$ ja gravados no banco.
